...
- **Cleanup B (#55) deferral held.** The temptation to "just rename `memoryhub` while we're touching it" was real and was correctly resisted. The package layout doc (`docs/design/package-layout.md`) was the single touchpoint we needed.
